...
- **32 diseños** (30 de lámina más `foco` y `camara`): idea, lista, flujo, sistema de pasos 1-2-3,
...
El demo con 30 de los 32 diseños (un catálogo; `foto` y `anfitrion` necesitan una imagen real o de IA que aporta el usuario, y se prueban en `pruebas/`), en [`ejemplos/demo/deck.json`](ejemplos/demo/deck.json). Los modelos de
