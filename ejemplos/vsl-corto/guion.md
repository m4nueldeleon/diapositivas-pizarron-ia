...
- Pieza: `vsl-corto` (ARCOS.md): promesa y mecanismo antes del segundo 25, revelación al ~59%, 1 objeción antes de la
...
| 13 | Resumen y por qué ahora | 27-28 | `lista` «Te llevas:» y la consecuencia concreta de esperar |
| 14 | **Llamado 2, el mismo botón** | 29 `boton` | una sola acción en toda la pieza: nada de mezclar el botón con «escríbeme CITA por WhatsApp» |
